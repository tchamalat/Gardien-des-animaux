...
<div class="profile-container">
    ...
    <div class="profile-picture">
        <img src="display_image.php" alt="Photo de profil">
    </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <?php if ($row['url_photo']): ?>
                            <img src="data:image/jpeg;base64,<?php echo base64_encode($row['url_photo']); ?>" alt="Photo">
                        <?php endif; ?>
                    </div>
                    <button type="submit" name="update_animal" class="btn">Modifier</button>
                    <button type="submit" name="delete_animal" class="btn" onclick="return confirm('Supprimer cet animal ?');">Supprimer</button>
                </form>
            </div>
        <?php endwhile; ?>
    </div>
