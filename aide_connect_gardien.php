    ...
    <style>
        ...
        * {
        ...
        .help-center-container {
            max-width: 800px;
            margin: 150px auto; /* Espace sous l'en-tête fixe */
...
<div class="help-center-container">
    ...
    <div class="faq">
        ...
        <p>
            Oui, vous pouvez annuler une réservation via votre espace utilisateur. Consultez nos <a href="conditions_connect.php">Conditions Générales</a> pour connaître les politiques d'annulation applicables.
        </p>
