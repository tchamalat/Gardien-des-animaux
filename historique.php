            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php elseif ($row['validite'] == 1 && $row['paiement_effectue'] == 0): ?>
                            <a href="paiement.php?id=<?php echo $row['id_reservation']; ?>" class="btn-small">Payer</a>
                        <?php elseif (is_null($row['validite'])): ?>
                            <a href="supprimer_reservation.php?id=<?php echo $row['id_reservation']; ?>" class="btn-small" onclick="return confirm('Voulez-vous vraiment supprimer cette réservation ?');">Supprimer</a>
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
