...
<div style="text-align : center; andimation: appear 1s ease ; overflow-y : scroll; height : 480px;">';
                    ...
                    if (is_array($myusers)) {
                     ...
                     <div id='contact' style='position:relative;' userid= '$row->userid'onclick= 'start_chat(event)'>
                           ...
                           $mydata .= "  <div style='width:20px; height:20px;  border-radius:50%; background-color:orange; color:white; position:absolute; left:0; top:0;'>".$msgs[$row->userid]."</div>";
                           }
                             $mydata .= "
                         </div>";
                        }
