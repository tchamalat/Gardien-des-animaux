...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-text">
            ...
            <button class="btn" onclick="window.location.href='/controllers/discussion.php'">Discussion</button>
        </div>
    </section>
    ...
    <section class="avis-section">
        ...
        <button class="voir-plus" onclick="window.location.href='/controllers/leave_review.php'">Laisser un avis</button>
    </section>
...
<a href="/controllers/discussion.php?username={gardien_username}" class="btn-discussion">Commencer une discussion</a>
